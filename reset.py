...
p1 = Post(body="www.google.com",timestamp=datetime.utcnow(),author=u1)
p2 = Post(body="www.youtube.com",timestamp=datetime.utcnow(),author=u1)
...
p1 = Post(body="www.google.com",timestamp=datetime.utcnow(),author=u3)
